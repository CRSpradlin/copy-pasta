...
},r]}}})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";return e=>({
...
subLanguage:"bash"}}]})})());hljs.registerLanguage("mathematica",(()=>{"use strict"
...
begin:/[[\](){}]/}]}}})());hljs.registerLanguage("coffeescript",(()=>{"use strict"
...
skip:!0})]}]})})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("java",(()=>{"use strict";return e=>{
...
className:"class",beginKeywords:"enum class struct union",end:/[{;:<>=]/,
contains:[{beginKeywords:"final class struct"},e.TITLE_MODE]}]),exports:{
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("less",(()=>{"use strict";return e=>{
...
t.name="Arduino",t.aliases=["ino"],t.supersetOf="cpp",t}})());hljs.registerLanguage("scilab",(()=>{"use strict";return e=>{
...
},e.COMMENT("//","$")].concat(n)}}})());hljs.registerLanguage("scss",(()=>{"use strict";return e=>{var t="@[a-z-]+",i={
...
illegal:"[^\\s\\}]"}}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("pgsql",(()=>{"use strict";return E=>{
...
className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("css",(()=>{"use strict";return e=>{
...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("vbscript",(()=>{"use strict";function e(e){
...
relevance:0}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{var n={
